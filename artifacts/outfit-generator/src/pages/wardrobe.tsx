...
const ROWS: { key: RowKey; label: string; btnLabel: string }[] = [
  { key: "outfits",    label: "+ Add Pet Details", btnLabel: "+ ADD PET DETAILS" },
  { key: "beauty",     label: "+ Add Health",      btnLabel: "+ ADD HEALTH"      },
  { key: "toiletries", label: "+ Add Care",        btnLabel: "+ ADD CARE"        },
  { key: "essentials", label: "+ Add Documents",  btnLabel: "+ ADD DOCUMENTS"  },
];
...
const LM = {
  ...
  rows: [
    ...
    { sectionTop: 0.400, shelfY: 0.590, btnCY: 0.483, carouselTop: 0.448 },  // HEALTH      (shelf 2)
    { sectionTop: 0.570, shelfY: 0.755, btnCY: 0.650, carouselTop: 0.640 },  // CARE        (shelf 3)
    { sectionTop: 0.735, shelfY: 0.910, btnCY: 0.815, carouselTop: 0.804 },  // RECORDS     (shelf 4)
  ],
      ...
      {ready && (
        <>
          ...
          <button
            ...
            style={{
              position: "absolute",
              top: pY(ir, 0.148), left: "50%", transform: "translateX(-50%)",
              zIndex: 25,
              padding: "5px 22px", borderRadius: 20, border: "none",
            ...
            >
              {saveSuccess ? (
                <div style={{ textAlign: "center", padding: "12px 0" }}>
                  ...
                  <p style={{ fontWeight: 800, fontSize: 16, fontFamily: "var(--font-display)" }}>Pet saved!</p>
                </div>
              ) : (
                <>
